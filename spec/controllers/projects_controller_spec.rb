...
RSpec.describe ProjectsController, type: :controller do
  describe "#index" do
    ...
    context "as a guest" do
      # 302レスポンスを返すこと
      it "returns a 302 response /index" do
        get :index
        expect(response).to have_http_status "302"
      end

      # POSTリクエストを送った際に302レスポンスを返すこと
      it "returns a 302 response :post" do
      ...
      # POSTリクエストを送った際にサインイン画面にリダイレクトすること
      it "redirects to the sign-in page" do
        project_params = FactoryBot.attributes_for(:project)
        post :create, params: { project: project_params }
        expect(response).to redirect_to "/users/sign_in"
  ...
  describe "#update" do
    ...
    context "as a guest" do
      before do
        @project = FactoryBot.create(:user)
      end
  ...
  describe "#destroy" do
    ...
    context "as a guest" do
      ...
      # プロジェクトを削除できないこと
      it "doen not delete the project" do
        expect{delete :destroy, params:{ id: @project.id}}.to_not change(Project,:count)
      end
    end
  end
